...
export async function generateMetadata({ params }: { params: Promise<Params> }): Promise<Metadata> {
    ...
    const getImageUrl = (): string => {
        ...
        if (article.content && Array.isArray(article.content)) {
            ...
            if (firstImageBlock && firstImageBlock.content) {
                return firstImageBlock.content.startsWith('http') ? firstImageBlock.content : `https://www.financialoutlook.xyz${firstImageBlock.content}`;
            }
        }
    ...
    const url = `https://www.financialoutlook.xyz/${category}/${slug}`;
...
export async function generateStaticParams() {
    ...
    for (const file of articles) {
        ...
        const category = article.category?.toLowerCase().replace(/\s+/g, '') || "news";
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        mainEntityOfPage: {
                            "@type": "WebPage",
                            "@id": `https://www.financialoutlook.xyz/${category}/${slug}`,
                        },
